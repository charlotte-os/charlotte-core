...
build-x86_64-docs:
	cd charlotte_core && cargo doc --target x86_64-unknown-none --no-deps --document-private-items

open-x86_64-docs: build-x86_64-docs
	xdg-open charlotte_core/target/x86_64-unknown-none/doc/charlotte_core/index.html
