//! Handle interrupts with the apic on x86_64
//!
...
use crate::cpu_control::{disable_interrupts, enable_interrupts, read_msr, write_msr};
use crate::interrupts::x86_64::consts::{
...
use crate::interrupts::HwTimerMode;
